/* Redirect stub for the old Duda URL /auto-window-tinting. See _moved/Moved.tsx and
...
const SPEC = LEGACY["auto-window-tinting"];

export const metadata = movedMetadata(SPEC);

export default function LegacyAutoWindowTintingPage() {
