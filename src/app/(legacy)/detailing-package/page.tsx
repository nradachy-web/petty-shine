/* Redirect stub for the old Duda URL /detailing-package. See _moved/Moved.tsx and
...
const SPEC = LEGACY["detailing-package"];

export const metadata = movedMetadata(SPEC);

export default function LegacyDetailingPackagePage() {
