...
const TINT: LandingTrack = {
  ...
  checks: [
    {
      title: "UV protection for you and the interior",
      body: "Factory glass lets UV through. Film blocks nearly all of it, which is what fades a dash and ages the skin on your left arm.",
    },
    {
      title: "A cooler cabin",
      body: "Ceramic film rejects infrared heat, so the car is cooler to get into and the air conditioning works less.",
    },
    {
      title: "Color stable ceramic",
      body: "Not the cheap dyed film that turns purple and bubbles after a couple of summers. Ceramic holds its color.",
    },
    {
      title: "No interference",
      body: "Ceramic is non metallic, so GPS, phone, radio and Bluetooth work exactly as they did before.",
    },
    {
  ...
  proofRows: [
    ...
    { k: "Warranty", v: "Confirmed for your vehicle with your quote" },
  ],
  reviewName: null,
  faqs: [
    {
      q: "Laminate or ceramic?",
      a: "Ceramic rejects more heat, holds its color and costs more. Laminate is the value option and still cuts glare and UV. Tell us how the car is used and we will say which is worth the money on yours.",
    },
    {
      q: "How long until I can roll the windows down?",
      a: "Usually a few days in warm weather and about a week when it is cold or humid. Keep the windows up while the film cures. We tell you the exact wait at pickup.",
    },
    {
      q: "Will it affect my electronics?",
      a: "No. Ceramic film is non metallic, so GPS, phone, radio and Bluetooth all work normally.",
    },
    {
      q: "How long does the install take?",
      a: "Most tint jobs are done in a day. We give you a clear pickup time when you book.",
    },
    {
      q: "Can you remove old tint?",
      a: "Yes. Old, bubbled or purple film comes off first and the glass is cleaned before the new film goes on. Say there is old film when you ask for a quote and it is priced in.",
    },
    {
      q: "What decides the price?",
      a: "How many windows, the shape of the back glass, which film, and whether there is old film to remove. Quotes are free and priced on your glass.",
    },
  ],
  townFaq: (c) => ({
    q: `Do I bring the car to Randleman?`,
    a: `Yes, tint is done in the shop. ${c.name} is about ${c.minutes} minutes away on ${c.route}, and we give you a clear pickup time when you book.`,
  }),
  quoteKey: "tint",
  ctaLabel: "Get a Free Quote",
